...
if training:
    ...
    np.savetxt('./csv_8x8/train_optimal_distance.csv',optimal_train,delimiter=',',fmt='%f')
    np.savetxt('./csv_8x8/train_acc.csv',train_acc_list,delimiter=',',fmt='%f')
else:
    """
    Test model
    """
    ...
    np.savetxt('./csv_8x8/train_distance.csv',res_train,delimiter=',',fmt='%f')
    np.savetxt('./csv_8x8/optimval_distance.csv',optimal_train,delimiter=',',fmt='%f')
    np.savetxt('./csv_8x8/test_acc.csv',test_acc_list,delimiter=',',fmt='%f')	
