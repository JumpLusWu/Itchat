...
def loading_data(num_robots):
    ...
    distanceMatrices1 = pandas.read_csv('../../16x16_SeqData/distanceMatrices_Traing_500w.csv',
                                       header=None,
                                       nrows=5000000,
                                       sep=' ',
                                       dtype='float')
    ...
    distanceMatrices2 = pandas.read_csv('../../16x16_SeqData/distanceMatrices_Traing_300w.csv',
                                       header=None,
                                       nrows=3000000,
                                       sep=' ',
                                       dtype='float')
    ...
    assignmentMatrices1 = pandas.read_csv('../../16x16_SeqData/assignmentMatrices_Traing_500w.csv',
                                       header=None,
                                       nrows=5000000,
                                       sep=' ',
                                       dtype='float')
    assignmentMatrices1 = assignmentMatrices1.values
    assignmentMatrices2 = pandas.read_csv('../../16x16_SeqData/assignmentMatrices_Traing_300w.csv',
                                       header=None,
                                       nrows=3000000,
                                       sep=' ',
                                       dtype='float')
